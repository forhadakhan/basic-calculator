...
function App() {
  return (
    <div className='bg-info-subtle min-height-full min-vh-100'>
            <div className="container px-3 mx-auto">
                ...
                <div className="d-flex align-items-center justify-content-center bg-white mt-5 border border-bottom-0 rounded-top-5">
